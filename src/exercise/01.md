...
- Selbstständig mit Doku und Google lösen hilft beim Lerneffekt
- nicht ganz sicher, was der Untschied zwischen .append und .appendChild ist
  (letzteres hat IntelliSense vorgeschlagen)
- Learning durch console error: root.textContent als property statt Funktion
- root.id gefällt mir besser als musterlösung
